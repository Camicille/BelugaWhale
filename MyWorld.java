...
public class MyWorld extends greenfoot.World
{
    ...
    private int timerHouseOne, timerTrees, timerHealth = 0;
    private static int MAXHEALTH = 5;
    private int yCoord, score, health;
    private static int WORLDSPEED;
    ...
    public void itemSpawner(){
        ...
        if(Greenfoot.getRandomNumber(100) < 1 && timerHealth > 10){
            addObject (new Health(), 650, 200);
            timerHealth = 0;
        }
    }
